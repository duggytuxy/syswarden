...
failregex = (?i)^<HOST> \S+ \S+ (?:\[[^\]]*\]\s+)?"(?:GET|POST|HEAD|PUT|DELETE|PATCH|OPTIONS) [^"]*?(?:(?:/|\x252f|\x25252f)(?:bin|usr(?:/|\x252f|\x25252f)bin)(?:/|\x252f|\x25252f)(?:bash|sh|dash|zsh|ash)|(?:nc|ncat|socat)(?:\s+|\x2520|\x252520|\x2509|\+)+(?:-e|-c)|(?:curl|wget|fetch|tftp)(?:\s+|\x2520|\x252520|\x2509|\+)+(?:-q|-s|-O|http)|(?:python|perl|ruby|php|node|lua|awk)(?:\s+|\x2520|\x252520|\x2509|\+)+-(?:c|e|r)|(?:;|\x253b|\x25253b|\||\x257c|\x25257c|`|\x2560|\x252560|\$|\x2524|\x252524)(?:\s+|\x2520|\x252520|\x2509|\+)*(?:bash|sh|nc|ncat|socat|curl|wget|chmod|openssl)).*?" .*$
ignoreregex = 
EOF
    fi
