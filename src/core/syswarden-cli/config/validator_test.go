...
func TestCustomValidators(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "bounded whitelist", value: []string{"10.20.30.40", "192.0.2.0/24", "fd00:1234::/64"}, tag: "ip_or_cidr_slice"},
		{name: "retired zero whitelist host", value: []string{"0.0.0.0"}, tag: "ip_or_cidr_slice", wantErr: true},
		{name: "retired zero whitelist prefix", value: []string{"0.0.0.0/32"}, tag: "ip_or_cidr_slice", wantErr: true},
		{name: "other unsafe whitelist", value: []string{"127.0.0.1"}, tag: "ip_or_cidr_slice", wantErr: true},
		{name: "overbroad whitelist", value: []string{"8.8.0.0/16"}, tag: "ip_or_cidr_slice", wantErr: true},
