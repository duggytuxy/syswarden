...
var manualCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Printf("  HA API: configurable TCP port, default 62026, self-signed TLS.\n")
		fmt.Printf("  HA client certificate verification is disabled; tokenless legacy mode exists.\n")
