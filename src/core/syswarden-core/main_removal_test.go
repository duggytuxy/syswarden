...
func checkedCoreTestIdentity(t *testing.T, name string, value int) uint32 {
	t.Helper()
	wide := int64(value)
...
func coreTestIdentity(t *testing.T) (uint32, uint32) {
	t.Helper()
	return checkedCoreTestIdentity(t, "UID", os.Geteuid()), checkedCoreTestIdentity(t, "GID", os.Getegid())
}
