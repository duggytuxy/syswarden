...
EOF
        ...
        if [[ "${USE_WIREGUARD:-n}" == "y" ]]; then
            ...
            # --- STRICT ZERO TRUST HIERARCHY (v1.96) - DEBIAN PARITY) ---
...
# ==============================================================================
# SYSWARDEN v1.96 - NGINX SECURE DASHBOARD (BOOTSTRAP 5 / HTTPS / CSP / LOCAL FONTS)
# ==============================================================================
...
if [[ "$MODE" != "update" ]]; then
    clear
    echo -e "${GREEN}#############################################################"
    echo -e "#     SysWarden Tool Installer (Universal v1.96)     #"
    echo -e "#############################################################${NC}"
fi
