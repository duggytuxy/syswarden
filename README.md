...
```bash
cd /usr/local/bin/
wget https://github.com/duggytuxy/syswarden/releases/download/v1.11/install-syswarden.sh
...
```bash
cd /usr/local/bin/
wget https://github.com/duggytuxy/syswarden/releases/download/v1.11/install-syswarden-alpine.sh
