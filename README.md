...
| :---: | :--- | :---: |
| **v0.36.** | Attack Surface Reduction: Migration from Dashboard UI to isolated Terminal UI (TUI) via `syswarden tui`. | ✅ |
| **v0.37.** | Enterprise SIEM Integration: Syslog output standardization for deterministic log ingestion. | ✅ |
